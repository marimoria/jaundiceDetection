...
for key, desc in [("1A", "Detection + Meta"), ("1B", "Detection Only")]:
    ...
    logging.info(classification_report(y, preds, target_names=["Normal", "Jaundiced"], zero_division=0))
...
fig3.suptitle("TSB Regression Evaluation — Models 2A / 2B", fontsize=13, fontweight="bold")
...
ax4.set_title("Bhutani Nomogram with Model 2A TSB Predictions", fontsize=12, fontweight="bold")
